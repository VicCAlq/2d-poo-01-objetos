Data de atualização: Dia 26/6/2026 às 15:32 
...
| AtvMetodoComplicado | Testando a quantidade de poções compradas pelo método loja do personagem com 3 itens comprados: | ✅ | ❌ | Error: Número de poções de cura não corresponde ao esperado após compra. |
| AtvMetodoComplicado | Testando a quantidade de troco restante após uso do método loja do personagem com 3 itens comprados: | ✅ | ❌ | Error: Número de moedas restantes não corresponde ao esperado após compra. |
...
| AtvMetodoMedio | Testando o método cura do personagem: | ✅ | ✅ | Sem erros |
