...
| AtvMetodoComplicado | Testando a quantidade de poções compradas pelo método comprarPorcoes do personagem com 3 itens comprados: | ✅ | ❌ | Error: Número de poções de cura não corresponde ao esperado após compra. |
| AtvMetodoComplicado | Testando a quantidade de troco restante após uso do método comprarPorcoes do personagem com 3 itens comprados: | ✅ | ❌ | Error: Número de moedas restantes não corresponde ao esperado após compra. |
